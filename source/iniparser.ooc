...
iniparser_getboolean: extern func(d: DictPtr, key: const String, notfound: Int) -> Bool
//iniparser_setstr: extern func(ini: DictPtr, entry: String, val: String) -> Int
iniparser_setstring: extern func(ini: DictPtr, entry: String, value: String) -> Int
